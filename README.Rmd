...
knitr::include_graphics(file.path("images", "ReadMe_Timeline.png"))
```
...
knitr::include_graphics(file.path("images", "ReadMe_AnnotatedTimeline.png"))
```
## Leaflet Maps
...
knitr::include_graphics(file.path("images", "ReadMe_LeafletMap.png"))
```
...
knitr::include_graphics(file.path("images", "ReadMe_FancyLeafletMap.png"))
```
## Links:
